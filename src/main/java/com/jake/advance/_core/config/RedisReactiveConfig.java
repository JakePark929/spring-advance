...
@Configuration
public class RedisReactiveConfig implements ApplicationListener<ApplicationReadyEvent> {
...
//        reactiveRedisTemplate.opsForValue().set("sampleKey", "sample", Duration.ofSeconds(60)).subscribe();
    }
